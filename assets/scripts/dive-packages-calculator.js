document.addEventListener('DOMContentLoaded', () => {
    ...
    const parseCount = (value, fallback, min = 0) => {
    ...
    const updateQuote = () => {
        ...
        const divers = parseCount(calculatorForm.querySelector('#diver-count')?.value, 2, 1);
        const nonDivers = parseCount(calculatorForm.querySelector('#non-diver-count')?.value, 0, 0);
